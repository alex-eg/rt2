...
fn main() {
    ...
    let res = resource::ResourceLoader::new();
    ...
    let sphere1 = new_sphere("s1", Vec3::new(15., 15., 15.), 5., green);
    let box1 = new_box(
        "b1",
        Vec3::new(10., 10., -20.),
        Vec3::new(20., 20., -10.),
    ...
    let sphere3 = new_sphere("s5", Vec3::new(-15., 15., 15.), 5., blue);
    let sphere4 = new_sphere("s6", Vec3::new(-15., 15., -15.), 5., red);
    let sphere5 = new_sphere("s3", Vec3::new(15., -15., 15.), 5., green);
